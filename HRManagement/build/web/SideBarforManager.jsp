<%-- Document : SideBarforManager Created on : Feb 21, 2024, 1:03:10 PM Author : NCM --%>
                ...
                <div class="header">
                    <div class="header-left">
                        <a href="dashboard" class="logo">
                            <img src="assets/img/pngtree-hacker-logo-png-image_6408677.png" width="35" height="35"
                                alt=""><span>BeztTech</span>
                        </a>
                    </div>
                    ...
                    <ul class="nav user-menu float-right">
                        <li class="nav-item dropdown d-none d-sm-block">
                            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"><i
                                    ...
                                    class="badge badge-pill bg-danger float-right">${notificationCount}</span></a>
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <p class="noti-details"><span
                                                                    class="noti-title">${notification.subject}</span>
                                                            </p>
                    ...
                    <div class="sidebar-inner slimscroll">
                        <div id="sidebar-menu" class="sidebar-menu">
                            <ul>
                                ...
                                <li>
                                    <a href="HomeEmployees"><i class="fa fa-check-square-o"></i> <span>Take
                                            Attendance</span></a>
                                </li>
                                <li>
                                ...
                                <li class="submenu">
                                    <a href="employee"><i class="fa fa-id-card"></i> <span>Employees</span> <span
                                            class="menu-arrow"></a>
                                ...
                                <li>
                                    <a href="AttendanceReport"><i class="fa fa-flag-o"></i> <span>Attendance
                                            Report</span> </a>
                                </li>
                                <li>
                                    <a href="AttendanceSheet"><i class="fa fa-calendar"></i> <span>Attendance
                                            Sheet</span></a>
                                </li>
                                <li>
                                    <a href="viewsendapplication"><i class="fa fa-paper-plane-o"></i> <span>View
                                            Application</span> </a>
                                </li>
                                ...
                                <li>
                                    <a href="AllNotification"><i class="fa fa-bell-o"></i> <span>View All
                                            Notification</span></a>
                                </li>
                                <li>
                                    <a href="ManagerNotification"><i class="fa fa-bell"></i>
                                        <span>Notification</span></a>
                                </li>
                                <li>


                                    <a href="ExportFileController"><i class="fa fa-download"></i> <span>Export
                                            File</span></a>
                                </li>
                                <li>
