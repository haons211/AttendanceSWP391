 ...
 * @author Dan
 */
@WebServlet(name="ForgotPasswordController", urlPatterns={"/ForgetPassword"})
public class ForgetPasswordController extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       dao.resetDefaultPassword(accountDTO.getUserID());
        request.setAttribute("successful", "Reset password has been successfull");
       request.getRequestDispatcher("ForgetPassword.jsp").forward(request, response);
    }
