...
public class EditFeedback extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            Logger.getLogger(EditFeedback.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    throws ServletException, IOException {
       ...
       System.out.println(otherTitle);
        ...
        if (title != null ) {
            try {
                dao.updateFeedback(new Feedback(acc.getUserID(), title, content, dateString),id );
        ...
        if (otherTitle != null) {
            try {
                dao.updateFeedback(new Feedback(acc.getUserID(), otherTitle, content, dateString), id);
            } catch (SQLException ex) {
                Logger.getLogger(EditFeedback.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
