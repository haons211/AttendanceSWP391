 ...
 * @author NCM
 */
@WebServlet(name="UpdateTaskController", urlPatterns={"/UpdateTask"})
public class UpdateTaskController extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            boolean i= pd.UpdateTask(id, NaMe, Des, dateFormat.parse(dateEndstr));
           response.sendRedirect("createTask?ProjectID="+pd.getProjectIDbyTask(id));
