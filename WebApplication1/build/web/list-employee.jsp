                ...
                <div class="content">
                    ...
                    <form action="search-employee" method="get">
                        <div class="row filter-row">       
                            ...
                            <div class="col-sm-6 col-md-4">
                                <input type="submit" class="btn btn-success btn-block" name="searchValue" value = "Search"> 
                            </div>
                        </div>
                    </form>
                    <div class="row">
                                ...
                                <table class="table table-striped custom-table">
                                    ...
                                    <tbody>
                                        <c:forEach var="e" items="${requestScope.employeeList}">
                                           <c:set var="id" value="${e.employeeId}"/> 
                                            <tr>
                                                <td>${e.name}</td>
                                                <td>${e.employeeId}</td>
                                                <td>${e.email}</td>
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="update-employee?id=${id}"><i class="fa fa-pencil m-r-5"></i>Update</a>
                                                            <a class="dropdown-item" href="#"  onclick="doDelete('${id}')" data-toggle="modal" data-target="delete-employee"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
